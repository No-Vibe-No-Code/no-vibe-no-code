...
Object.assign(copy.en, { heroQrText: "Scan the poster to join the group, see the Club Fair plan, and get the first-meeting details when they are confirmed.", heroQrMeta: "Scan the poster · WeChat group QR" });
Object.assign(copy.zh, { heroQrText: "扫码海报加入群聊，查看 Club Fair 计划，并在第一次活动确认后收到时间和教室信息。", heroQrMeta: "扫码海报 · 微信群二维码" });
